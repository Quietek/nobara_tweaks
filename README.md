...
> ./nobara_tweaks_setup
4. Follow/answer the prompts, inputting your password when asked. You may be required to create a temporary user to change your username. You may also be required to make changes to your BIOS settings for secure boot to function correctly.

## Sway keyboard shortcuts
By default the sway config generated by this script contains the following keyboard shortcuts.
> Windows + [1-9] 
> Windows + Shift + [1-4]
> Windows + Shift + [5-9]
...
> Windows + Ctrl + Shift + [
> Windows + Ctrl + Shift + ]
These can be changed by modifying ***~/.config/sway/config*** in any text editor.
